          ...
          where T : class
    {
        ...
        public async Task<T?> GetById(int id, bool isTracking = true)
        {
            if (!isTracking)
            {
                ...
                return await _applicationDbContext.Set<T>().AsNoTracking().Where(genericPredicate).FirstOrDefaultAsync();
            }
        ...
        public IQueryable<T> SearchFor(Expression<Func<T, bool>> predicate = null, string include = null, bool hasTracking = true)
        {
